...
export type Gallery7Props = React.ComponentPropsWithoutRef<"section"> & Props;
        ...
        <div className="grid auto-cols-fr justify-center gap-6 md:grid-cols-2 md:gap-8">
          {images.map((image, index) => (
            <a
              ...
              href={image.url}
              className={clsx(
                "inline-block w-full ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-border-primary focus-visible:ring-offset-2",
                {
...
const Gallery7Defaults: Gallery7Props = {
