...
export type Layout364Props = React.ComponentPropsWithoutRef<"section"> & Props;
        ...
        <div className="grid grid-cols-1 items-start gap-6 md:grid-cols-2 md:gap-8">
          {sections.map((section, index) => (
            <div
              ...
              className="border border-border-primary p-6 md:p-8 lg:p-12"
            >
...
const Layout364Defaults: Layout364Props = {
  tagline: "Tagline",
