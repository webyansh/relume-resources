...
export type Layout66Props = React.ComponentPropsWithoutRef<"section"> & Props;
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 py-2">
            {features.map((feature, index) => (
              <div key={`${feature.description}-${index}`} className="flex self-start">
...
const Layout66Defaults: Layout66Props = {
