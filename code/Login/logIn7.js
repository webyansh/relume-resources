...
export type Login7Props = React.ComponentPropsWithoutRef<"section"> & Props;
        ...
        <div className="relative mx-[5vw] flex items-center justify-center pb-16 pt-20 md:pb-20 md:pt-24 lg:py-20">
          <div className="container max-w-sm">
            ...
            <form className="grid grid-cols-1 gap-6" onSubmit={handleSubmit}>
              ...
              <div className="grid w-full items-center">
                <div className="flex items-start justify-between">
                  ...
                  <a href={forgotPassword.url} className="underline focus-visible:outline-none">
                    {forgotPassword.text}
                  </a>
                </div>
                <Input
            ...
            <div className="mt-5 inline-flex w-full items-center justify-center gap-x-1 text-center md:mt-6">
              <p>{signUpText}</p>
              <a href={signUpLink.url} className="underline focus-visible:outline-none">
                {signUpLink.text}
              </a>
            </div>
          </div>
...
const Login7Defaults: Login7Props = {
  logo: {
